...
const content = {
  en: {
    ...
    sectionA: 'A. Why did you join this challenge?',
    aOtherPlaceholder: 'Is there anything else you\'d like to share? (Optional)',
    sectionB: 'B. What do you hope to achieve in these 8 weeks?',
  ...
  zh: {
    ...
    sectionA: 'A. 您为什么参加本次挑战赛？',
    aOtherPlaceholder: '如有其他想补充的内容，欢迎自由填写。（选填）',
    sectionB: 'B. 您希望在这 8 周内实现什么目标？',
...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="min-h-screen bg-wellinder-cream py-16 px-6">
      <motion.div
