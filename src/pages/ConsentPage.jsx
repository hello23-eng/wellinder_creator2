...
const content = {
  en: {
    ...
    items: [
      ...
      'I understand that training sessions, guest sessions, and future collaboration opportunities may be prioritized for participants who meet the activity requirements.',
      'I understand that all program materials — including educational content, guides, templates, guest session content, and community shares — are provided solely for personal learning and participation in this program.',
      ...
      'I agree not to publicly disclose or reuse any non-public operational information, educational content, guest session content, community shares, or internal materials obtained through this program.',
      ...
      'I understand that my account name and activity may be visible to other participants on the program leaderboard.',
    ],
  ...
  zh: {
    ...
    items: [
      ...
      '我了解培训课程、嘉宾分享及后续合作机会将优先提供给达到活动标准的参与者。',
      '我了解项目提供的所有资料（包括教育内容、指南、模板、嘉宾分享内容及社群共享内容等）仅供个人学习及完成项目任务之用。',
      '我同意未经品牌事先授权，不对外分享、复制、传播、上传、录制、截取项目相关资料或内容，亦不将其转交给第三方。',
      '我同意不对外披露或再利用在项目期间获悉的任何未公开运营信息、教育内容、嘉宾分享内容、社群共享内容及其他内部资料。',
      '我了解违反运营规范或资料保护原则，可能导致被终止项目参与资格，并限制未来与品牌的合作及项目参与机会。',
      '我了解我的账号名称及活动情况可能在项目排行榜上对其他参与者公开显示。',
    ],
